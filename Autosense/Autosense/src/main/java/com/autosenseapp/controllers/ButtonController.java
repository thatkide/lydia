...
public class ButtonController implements View.OnClickListener, View.OnLongClickListener, View.OnDragListener {
	...
	public boolean onDrag(View view, DragEvent dragEvent) {
		...
		com.autosenseapp.databases.Button button = (com.autosenseapp.databases.Button) v.getTag();

		// rearrange
		if (view.getTag() instanceof com.autosenseapp.databases.Button) {
			switch (dragEvent.getAction()) {
				case DragEvent.ACTION_DRAG_ENTERED: {
					// get the proper background resource
					int pos = ((com.autosenseapp.databases.Button) view.getTag()).getPosition();
	...
	public void drawScreen() {
		...
		List<com.autosenseapp.databases.Button> buttonsInDb = dataSource.getButtonsInArea(buttonType, selectedScreen, group);
		...
		if (admin) {
			...
			for (int i = 0; i < adminNumButtons; i++) {
				...
				// get the button
				Button button = (Button) activity.findViewById(resId);
				com.autosenseapp.databases.Button myButton = new com.autosenseapp.databases.Button();
		...
		try {
			...
			if (!admin) {
				if (view.getTag() instanceof com.autosenseapp.databases.Button) {
					...
					com.autosenseapp.databases.Button passedButton = (com.autosenseapp.databases.Button) view.getTag();
