...
//					Toast.makeText(getApplicationContext(), readMessage, Toast.LENGTH_LONG).show();
	...
	private BroadcastReceiver smsReplyReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			// store message in db
			messagesDataSource.createMessage(sms.getMessage(), sms.getToNumber(), com.autosenseapp.databases.Message.TYPE_SMS, true);
	...
	private BroadcastReceiver mediaInfoReceiver = new BroadcastReceiver() {
		@Override
		public void onReceive(Context context, Intent intent) {
			Song song = (Song) intent.getSerializableExtra("com.autosenseapp.Song");
